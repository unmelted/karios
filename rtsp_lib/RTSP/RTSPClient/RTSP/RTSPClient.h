...
public:
	...
	unsigned long long beginTimeStamp() { return fbeginTimeStamp; }
	unsigned long long dateTimeStamp() { return fDateTimeStamp; }
...
protected:
	...
	bool parseRTPInfoHeader(char*& line, unsigned short& seqNum, unsigned long long& timestamp);
	bool parseDateHeader(char const* line, unsigned long long& time);
...
protected:
	...
	double			fPlayEndTime;
	unsigned long long	fDateTimeStamp;
	unsigned long long	fbeginTimeStamp;
